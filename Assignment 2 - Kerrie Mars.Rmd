---
title: "Assignment 2  Kerrie Mars"
author: "Kerrie Mars"
date: "2022-09-26"
...
valid.norm.df[, -7]  <-predict(norm.values, valid_data[, -7])
bank.norm.df[, -7] <-predict(norm.values, bank_data[, -7])

#use knn() to compute knn
knn.1 <- knn(train = train.norm.df[, -7], test = bank.norm.df[, -7], cl = train.norm.df[, 7], k=5, prob=TRUE)
